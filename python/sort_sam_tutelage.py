...
df.sort_values("Day to Apply").to_excel("docs/sam_tutelage.xlsx", index=False)

print("Royal spreadsheet sorted at SevenVoices/docs/sam_tutelage.xlsx, Your Grace!")